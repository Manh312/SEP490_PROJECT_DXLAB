...
const AccountDetail = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-20 mb-40 p-6 rounded-lg shadow-xl border transition-all">
        ...
        <table className="w-full text-left">
          <tbody>
            <tr className="border-b bg-gray-500">
              <td className="px-4 py-3 font-semibold text-white">Họ Và Tên</td>
              <td className="px-4 py-3 text-white">{account.fullName}</td>
            </tr>
