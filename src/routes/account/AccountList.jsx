...
const AccountList = () => {
  ...
  return (
    <div className="py-4 px-2 sm:px-4 lg:px-8 mb-10">
      ...
      <div className="max-w-full sm:max-w-5xl mx-auto rounded-xl shadow-lg p-4 sm:p-6 lg:p-8">
        {/* Header Section */}
              ...
              <div className="hidden md:block overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead className="border-b">
                    <tr>
                      <th className="px-2 py-2 md:px-3 md:py-3 font-semibold text-xs uppercase tracking-wide">#</th>
                      <th className="px-2 py-2 md:px-3 md:py-3 font-semibold text-xs uppercase tracking-wide">Họ và Tên</th>
                      <th className="px-2 py-2 md:px-3 md:py-3 font-semibold text-xs uppercase tracking-wide">Email</th>
                      <th className="px-2 py-2 md:px-3 md:py-3 font-semibold text-xs uppercase tracking-wide">Vai Trò</th>
                      <th className="px-2 py-2 md:px-3 md:py-3 font-semibold text-xs uppercase tracking-wide">Hành Động</th>
                    </tr>
                  </thead>
                  <tbody>
                    {currentPosts.map((user, index) => (
                      <tr key={user.id} className="border-b hover:bg-gray-500 transition-colors">
                        <td className="px-2 py-3 md:px-3 md:py-4">{(currentPage - 1) * postsPerPage + index + 1}</td>
                        <td className="px-2 py-3 md:px-3 md:py-4">{user.fullName}</td>
                        <td className="px-2 py-3 md:px-3 md:py-4">{user.email}</td>
                        ...
                        <td className="px-2 py-3 md:px-4 md:py-4 flex gap-2">
                          <button
