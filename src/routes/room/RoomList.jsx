            ...
            {room.map((room, index) => (
              <tr key={room.id} className="hover:bg-gray-500 transition">
                ...
                <td className="p-3 text-center">
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${room.status === "Còn trống" ? "bg-green-200 text-green-700"
                ...
                <td className="p-3 flex justify-center gap-x-3">
                  ...
                  <button
                    ...
                    onClick={() => navigate(`/dashboard/room/update/${room.id}`)}
                  >
                    <PencilLine size={22} />
                  </button>
                  <button
