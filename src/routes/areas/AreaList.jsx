          ...
          <table className="table min-w-full">
            <thead className="table-header">
              <tr className="table-row">
                <th className="table-head sticky top-0 bg-orange-500">#</th>
                <th className="table-head sticky top-0 bg-orange-500">Product</th>
                <th className="table-head sticky top-0 bg-orange-500">Price</th>
                <th className="table-head sticky top-0 bg-orange-500">Status</th>
                <th className="table-head sticky top-0 bg-orange-500">Rating</th>
                <th className="table-head sticky top-0 bg-orange-500">Action</th>
              </tr>
